...
from .freedrag_utils import freedrag_update, freedrag_update_gen
...
def run_drag(source_image,
    ...
    updated_init_code = freedrag_update(model, init_code, t,
...
def run_drag_gen(
    ...
    updated_init_code = freedrag_update_gen(model, init_code, t,
        handle_points, target_points, mask, args)
